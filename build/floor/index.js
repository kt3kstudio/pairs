...
},{"spn":2}],31:[function(require,module,exports){
'use strict';
...
var _require = require('spn'),
    wait = _require.wait,
    _require$animation = _require.animation,
    show = _require$animation.show,
    hide = _require$animation.hide;
...
var Door = (_dec = show('door-appear', DOOR_APPEAR_DUR), _dec2 = hide('door-disappear', DOOR_APPEAR_DUR), component(_class = _dec(_class = _dec2(_class = function (_FloorAsset) {
  ...
  _createClass(Door, [{
    ...
    value: function __init__() {
      _get(Door.prototype.__proto__ || Object.getPrototypeOf(Door.prototype), '__init__', this).call(this);
...
},{"../../util":56,"./floor-asset":33,"dom-gen":1,"spn":2}],32:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./floorboard":35,"dom-gen":1,"spn":2}],33:[function(require,module,exports){
'use strict';
...
var FloorAsset = (_dec = width(80), _dec2 = height(100), _dec3 = ratio.x(0.5), _dec4 = ratio.y(1), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = function (_Body) {
  ...
  function FloorAsset() {
    ...
    return _possibleConstructorReturn(this, (FloorAsset.__proto__ || Object.getPrototypeOf(FloorAsset)).apply(this, arguments));
  }
  ...
  _createClass(FloorAsset, [{
    ...
    value: function spawnFrog() {
      var frog = $('<img />').css({ zIndex: 2 }).appendTo(this.elem).cc('frog').cc.get('frog');
...
},{"../../util":56,"spn":2}],34:[function(require,module,exports){
'use strict';
...
var _require2 = require('../../ui'),
    sprite = _require2.sprite;

var _require3 = require('../../util'),
    trigger = _require3.trigger;
...
var FloorWalker = (_dec = sprite.character, _dec2 = ratio.x(0.5), _dec3 = ratio.y(1), _dec4 = on('door-knock'), _dec5 = on('character-goto'), _dec(_class = _dec2(_class = _dec3(_class = component(_class = (_class2 = function (_Body) {
  _inherits(FloorWalker, _Body);

  function FloorWalker() {
    _classCallCheck(this, FloorWalker);

    return _possibleConstructorReturn(this, (FloorWalker.__proto__ || Object.getPrototypeOf(FloorWalker)).apply(this, arguments));
  }
  ...
  _createClass(FloorWalker, [{
    ...
    value: function characterGoto(e) {
      ...
      this.character.reloadAll().then(function () {
        ...
        return trigger(_this3.elem, 'scene-reload');
      });
    }
    ...
    value: function moveToFloorAsset(floorAsset) {
      ...
      return this.engage(goOutDur).then(function () {
        ...
        trigger(_this4.el, 'camera-move', { x: floorAsset.x, dur: moveOnCorridor });
  ...
  return FloorWalker;
}(Body), (_applyDecoratedDescriptor(_class2.prototype, 'doorKnock', [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, 'doorKnock'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'characterGoto', [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, 'characterGoto'), _class2.prototype)), _class2)) || _class) || _class) || _class) || _class);


module.exports = FloorWalker;

},{"../../ui":47,"../../util":56,"spn":2}],35:[function(require,module,exports){
'use strict';
...
},{"spn":2}],36:[function(require,module,exports){
'use strict';
...
var FrogSprite = (_dec = sprite.stayRun, _dec2 = width(100), _dec3 = height(50), _dec4 = ratio.x(0.5), _dec5 = ratio.y(1), _dec6 = component('frog'), _dec7 = on('click'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = (_class2 = function (_GridWalker) {
  _inherits(FrogSprite, _GridWalker);

  function FrogSprite() {
    _classCallCheck(this, FrogSprite);

    return _possibleConstructorReturn(this, (FrogSprite.__proto__ || Object.getPrototypeOf(FrogSprite)).apply(this, arguments));
  }
  ...
  return FrogSprite;
}(GridWalker), (_applyDecoratedDescriptor(_class2.prototype, 'jump', [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, 'jump'), _class2.prototype)), _class2)) || _class) || _class) || _class) || _class) || _class) || _class);


module.exports = FrogSprite;

},{"../../ui/sprite":50,"spn":2}],37:[function(require,module,exports){
'use strict';
...
},{"./camera":30,"./door":31,"./floor-asset-collection":32,"./floor-walker":34,"./floorboard":35,"./frog-sprite":36,"./level-key":38,"./staircase":39}],38:[function(require,module,exports){
(function (global){
'use strict';
...
var _capsid = capsid,
    component = _capsid.component;
var LevelKey = (_dec = sprite.static(global.BASEPATH + '/img/key.svg'), _dec2 = ratio.x(0.5), _dec3 = ratio.y(1), _dec4 = width(50), _dec5 = height(50), _dec6 = animation.show('char-appear', 1000), _dec7 = animation.hide('char-disappear', 1000), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = _dec7(_class = component(_class = function (_Body) {
  ...
  return LevelKey;
}(Body)) || _class) || _class) || _class) || _class) || _class) || _class) || _class) || _class);


module.exports = LevelKey;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../../ui/sprite":50,"spn":2}],39:[function(require,module,exports){
'use strict';
 ...
 */
var Staircase = (_dec = animation.show('door-appear', STAIRCASE_ANIMATION_DUR), _dec2 = animation.hide('door-disappear', STAIRCASE_ANIMATION_DUR), component(_class = _dec(_class = _dec2(_class = function (_FloorAsset) {
  ...
  _createClass(Staircase, [{
    key: '__init__',
    value: function __init__() {
      _get(Staircase.prototype.__proto__ || Object.getPrototypeOf(Staircase.prototype), '__init__', this).call(this);
...
},{"../../util":56,"./floor-asset":33,"spn":2}],40:[function(require,module,exports){
'use strict';
...
var _require = require('../util/location'),
    checkLocation = _require.checkLocation;
  ...
  _createClass(FloorScene, [{
    ...
    value: function sequenceUnlocking(levelKey) {
      ...
      return key.show().then(function () {
        ...
        trigger(_this6.el, 'camera-move', { x: key.getPoint().x, dur: keyGivingDur });
...
},{"../domain":10,"../ui/scene":48,"../util":56,"../util/location":57,"./component":37,"dom-gen":1}],41:[function(require,module,exports){
'use strict';

require('./floor-scene');

},{"./floor-scene":40}],42:[function(require,module,exports){
'use strict';
...
},{"spn":2,"traits-decorator":3}],43:[function(require,module,exports){
'use strict';
...
},{"../../util":56,"spn":2}],44:[function(require,module,exports){
'use strict';
...
},{"./block":43,"traits-decorator":3}],45:[function(require,module,exports){
'use strict';
...
},{"spn":2,"traits-decorator":3}],46:[function(require,module,exports){
'use strict';
...
},{"spn":2}],47:[function(require,module,exports){
'use strict';
...
},{"./being":42,"./block":44,"./body":45,"./scene":48,"./sprite":50}],48:[function(require,module,exports){
'use strict';
...
},{"./common/background-service":46}],49:[function(require,module,exports){
'use strict';
...
},{"./ma":51,"./sprite":53,"spn":2,"traits-decorator":3}],50:[function(require,module,exports){
'use strict';
...
},{"./char-sprite":49,"./relative-body":52,"./sprite":53,"./static-sprite":54,"./stay-run-sprite":55,"traits-decorator":3}],51:[function(require,module,exports){
'use strict';
...
},{"spn":2}],52:[function(require,module,exports){
"use strict";
...
},{"./sprite":53,"spn":2,"traits-decorator":3}],55:[function(require,module,exports){
'use strict';
...
},{"./sprite":53,"spn":2,"traits-decorator":3}],56:[function(require,module,exports){
'use strict';

exports.trigger = require('./trigger');

},{"./trigger":58}],57:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../domain":10}],58:[function(require,module,exports){
"use strict";

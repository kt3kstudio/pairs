...
var Exit = (_dec = animation.show('fade-in'), _dec2 = animation.hide('fade-out'), _dec3 = emit('exit-room'), _dec4 = on('click'), block(_class = _dec(_class = _dec2(_class = component(_class = (_class2 = function (_Body) {
  _inherits(Exit, _Body);
  ...
  _createClass(Exit, [{
    ...
    value: function block(rect) {
      return rect.scaleTop(3 / 10).scaleBottom(1 / 3).scaleLeft(5 / 9).scaleRight(1 / 5);
    }
  }, {
    key: 'show',
    value: function show() {
      ...
      return _get(Exit.prototype.__proto__ || Object.getPrototypeOf(Exit.prototype), 'show', this).call(this);
    }
  }, {
    key: 'didShow',
  ...
  return Exit;
}(Body), (_applyDecoratedDescriptor(_class2.prototype, 'exit', [_dec3, _dec4], Object.getOwnPropertyDescriptor(_class2.prototype, 'exit'), _class2.prototype)), _class2)) || _class) || _class) || _class) || _class);


module.exports = Exit;

},{"../../ui":42,"spn":2}],32:[function(require,module,exports){
'use strict';
...
var _capsid = capsid,
    component = _capsid.component;
var Hero = (_dec = sprite.character, _dec2 = ratio.x(0.5), _dec3 = ratio.y(1), _dec(_class = component(_class = _dec2(_class = _dec3(_class = function (_Body) {
  _inherits(Hero, _Body);
  ...
  _createClass(Hero, [{
    ...
    value: function willShow() {
      ...
      return _get(Hero.prototype.__proto__ || Object.getPrototypeOf(Hero.prototype), 'willShow', this).call(this);
    }
  }]);
...
},{"../../ui":42,"spn":2}],33:[function(require,module,exports){
'use strict';
...
},{"./bed":30,"./exit":31,"./hero":32,"./window":34}],34:[function(require,module,exports){
'use strict';
...
var _capsid = capsid,
    component = _capsid.component;
var Window = (_dec = animation.show('fade-in'), _dec2 = animation.hide('fade-out'), block(_class = component(_class = _dec(_class = _dec2(_class = function (_Body) {
  _inherits(Window, _Body);
  ...
  _createClass(Window, [{
    key: 'block',
    value: function block(rect) {
      return rect.scaleLeft(9 / 10).scaleRight(4 / 9).scaleTop(9 / 10).scaleBottom(2 / 9);
    }
  }, {
    key: 'show',
    value: function show() {
      ...
      return _get(Window.prototype.__proto__ || Object.getPrototypeOf(Window.prototype), 'show', this).call(this);
    }
  }, {
    key: 'didShow',
    value: function didShow() {
...
},{"../../ui":42,"spn":2}],35:[function(require,module,exports){
'use strict';

require('./room-scene');

},{"./room-scene":36}],36:[function(require,module,exports){
'use strict';
...
var _require3 = require('../util/location'),
    checkLocation = _require3.checkLocation;
...
var _capsid = capsid,
    on = _capsid.on,
    wire = _capsid.wire;
var RoomScene = (_dec = scene.primary, _dec2 = on('exit-room'), _dec(_class = (_class2 = function () {
  function RoomScene() {
  ...
  _createClass(RoomScene, [{
    ...
    value: function setUp() {
      ...
      return checkLocation(this.character.location, window.location).then(function () {
        return _this2.createHero(_this2.character).appendTo(_this2.el);
      }).then(function () {
        return _this2.createExit().appendTo(_this2.el);
      });
    }
  }, {
    key: 'start',
    value: function start() {
      ...
      return this.bg.turnWhite().then(function () {
        return _this3.window.show();
      }).then(function () {
        var r = _this3.window.blockRect;
        _this3.hero.setAt(new Point(r.centerX(), r.bottom + _this3.hero.actualHeight() + 15));
        return _this3.hero.show();
      }).then(function () {
        return _this3.exit.show();
      });
    }
  }, {
    key: 'exitRoom',
    value: function exitRoom() {
      ...
      return this.hero.engage().then(function () {
        _this4.window.hide();
        _this4.exit.hide();
      }).then(function () {
        return _this4.bg.turnBlack();
      }).then(function () {
    ...
    value: function createHero(character) {
      return img({ data: { character: character } }).cc('hero');
    }
  ...
  return RoomScene;
}(), (_applyDecoratedDescriptor(_class2.prototype, 'room', [wire], Object.getOwnPropertyDescriptor(_class2.prototype, 'room'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'window', [wire], Object.getOwnPropertyDescriptor(_class2.prototype, 'window'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'hero', [wire], Object.getOwnPropertyDescriptor(_class2.prototype, 'hero'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'exit', [wire], Object.getOwnPropertyDescriptor(_class2.prototype, 'exit'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'exitRoom', [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, 'exitRoom'), _class2.prototype)), _class2)) || _class);


module.exports = RoomScene;

},{"../domain":10,"../ui":42,"../util/location":52,"./component":33,"dom-gen":1,"spn":2}],37:[function(require,module,exports){
'use strict';
...
},{"spn":2,"traits-decorator":3}],38:[function(require,module,exports){
'use strict';
...
},{"../../util":51,"spn":2}],39:[function(require,module,exports){
'use strict';
...
},{"./block":38,"traits-decorator":3}],40:[function(require,module,exports){
'use strict';
...
},{"spn":2}],42:[function(require,module,exports){
'use strict';
...
},{"./being":37,"./block":39,"./body":40,"./scene":43,"./sprite":45}],43:[function(require,module,exports){
'use strict';
...
},{"./common/background-service":41}],44:[function(require,module,exports){
'use strict';
...
},{"./ma":46,"./sprite":48,"spn":2,"traits-decorator":3}],45:[function(require,module,exports){
'use strict';
...
},{"./char-sprite":44,"./relative-body":47,"./sprite":48,"./static-sprite":49,"./stay-run-sprite":50,"traits-decorator":3}],46:[function(require,module,exports){
'use strict';
...
},{"./sprite":48,"spn":2,"traits-decorator":3}],50:[function(require,module,exports){
'use strict';
...
},{"./sprite":48,"spn":2,"traits-decorator":3}],51:[function(require,module,exports){
'use strict';

exports.trigger = require('./trigger');

},{"./trigger":53}],52:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../domain":10}],53:[function(require,module,exports){
"use strict";
